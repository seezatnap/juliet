...
- [ ] Verify the first command executed is `swarm --help`.
- [ ] Verify `swarm run --project $PROJECT --max-sprints 1 --target-branch feature/$PROJECT` executes.
...
- [ ] Verify `swarm run --project sprint-1-followups --max-sprints 1 --target-branch feature/$PROJECT` executes.
