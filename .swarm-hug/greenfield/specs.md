...
runs `swarm run --project foo --max-sprints 1 --target-branch feature/foo`
...
`swarm run --project sprint-1-followups --max-sprints 1 --target-branch feature/foo`
