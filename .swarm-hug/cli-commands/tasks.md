...
- [x] (#12) Mark tasks #6 and #7 as complete in tasks.md — parser unit tests for `reset-prompt`, `clear-history`, and `exec` were delivered as part of #1's implementation on the feature branch (blocked by #1) (B)
...
## Follow-up tasks (from sprint review)
- [B] (#21) Fix task #2 marker in tasks.md — it still shows `[A]` instead of `[x]`; three prior attempts (#15, #19, #20) all failed to actually change it
